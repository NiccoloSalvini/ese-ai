...
| **10:55** | open your notebook — one click |
| **11:05** | break |
| **11:15** | from one neuron to an LLM, and one token’s journey through it |
...
About 15 trillion tokens of filtered web text — ~44 TB. Months of GPUs. Out comes a **base model**: it continues documents. Ask it a question and it may answer with three more questions.
:::
::: {.column width="33%"}
**2 · Post-training**
