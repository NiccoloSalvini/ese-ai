...
<!-- TODO Niccolò: three lines, your words — background, what you build, why this course. See week-01/speech.md -->

- what I do when I am not teaching
- the kind of systems I build, and where they broke
- why I teach this as a lab and not as a survey
:::
::::
...
## The questions I would like to answer by 10:40

:::: {.columns}
::: {.column width="50%"}
**Where you come from**

- the last three projects you were proud of — and one that went badly
- a decision at work that you made **without** the data you wanted
- which tools you open every day, and which ones you avoid
:::
::: {.column width="50%"}
**Where you want to go**

- what you want to be able to **do** in December that you cannot do today
- markets, crypto, DeFi: as a user, an investor, or a builder?
- the one question you would like a model to answer for you
:::
::::

[And one practical one: how do you learn best — trying first, or seeing it done first?]{.red}
...
## Where your interests sit on that map

| you said | where it lands | and before that |
|---|---|---|
...
[Most of what gets pitched as AI is a 1.0 problem with a 3.0 budget. Knowing which is which is worth more than anything else in these ten weeks. We run all three on the same transactions in week 3.]{.muted}
...
[Nobody charged you a fee. The price moved *because you traded*. That one line is an automated market maker, and in week 8 you simulate what it does to the people who fund the pool.]{.red}
