...
:::: {.columns}
::: {.column width="50%"}
**Inner join** — keep only days both have.

You lose every weekend. Crypto's real weekend moves disappear, and Monday's return quietly becomes a three-day move labelled as one day.
:::
::: {.column width="50%"}
**Forward fill** — carry Friday's price.

You invent two prices that never traded. Volatility is diluted by a third, and any model fed this learns from data that does not exist.
:::
::::

::: {.callout-tip title="The sentence to remember"}
Decide which days exist **before** you compute anything across assets, and write the decision down. There is no neutral default.
:::
