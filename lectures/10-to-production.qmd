...
A latency budget is a sum, and it either fits or it does not:

| | |
|---|---|
| retrieval | 120 ms |
| model, time to first token | 400 ms |
| generation | `tokens_out ÷ tokens per second` |
| your own code | whatever you measured |

[Against a target you state up front. "It feels quick" is not a budget, and it stops being true under load.]{.red}
...
4. State your break-even value per query, and say whether you believe it.
