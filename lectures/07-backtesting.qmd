...
::: {.callout-tip title="The honest form"}
Count your attempts and report the number. A parameter search is only legitimate inside **walk-forward**: fit on a past window, test on the next, roll forward, never look back.
:::
